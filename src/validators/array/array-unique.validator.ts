...
export class ArrayUniqueValidator extends BaseValidator implements ValidatorInterface {
    constructor(private readonly uniqueIdentifier?: (o: any) => any, validationOptions?: ValidationOptionsInterface) {
...
// Decorator
export const arrayUnique = (uniqueIdentifier?: (o: any) => any, validationOptions?: ValidationOptionsInterface) => {
    return (
        /**
        ...
        const validator = new ArrayUniqueValidator(uniqueIdentifier, validationOptions);
